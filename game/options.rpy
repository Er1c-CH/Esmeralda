...
define config.name = _("Jornada Digital de Esmeralda")
...
define build.name = "JornadaDigitaldeEsmeralda"
...
define config.save_directory = "JornadaDigitaldeEsmeralda-1781732827"
